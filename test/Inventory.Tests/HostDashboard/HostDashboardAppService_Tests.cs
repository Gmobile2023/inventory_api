...
using Inventory.MultiTenancy.HostDashboard;
...
namespace Inventory.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(InventoryDbContext context, SubscriptionPayment subscriptionPayment)
        {
