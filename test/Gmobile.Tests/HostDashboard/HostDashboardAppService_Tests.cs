...
using Gmobile.MultiTenancy.HostDashboard;
...
namespace Gmobile.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(GmobileDbContext context, SubscriptionPayment subscriptionPayment)
        {
