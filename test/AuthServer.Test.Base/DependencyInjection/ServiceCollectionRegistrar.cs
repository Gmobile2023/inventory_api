...
namespace AuthServer.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<AuthServerDbContext>>()
            ...
            new AuthServerDbContext(builder.Options).Database.EnsureCreated();
        }
