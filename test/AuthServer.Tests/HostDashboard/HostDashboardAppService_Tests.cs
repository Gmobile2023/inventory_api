...
using AuthServer.MultiTenancy.HostDashboard;
...
namespace AuthServer.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(AuthServerDbContext context, SubscriptionPayment subscriptionPayment)
        {
