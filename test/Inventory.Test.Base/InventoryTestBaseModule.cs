...
using Inventory.Test.Base.DependencyInjection;
using Inventory.Test.Base.UiCustomization;
using Inventory.Test.Base.Url;
using Inventory.Test.Base.Web;
using Inventory.UiCustomization;
using Inventory.Url;
using NSubstitute;
...
namespace Inventory.Test.Base
{
    ...
    {
        public InventoryTestBaseModule(InventoryEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.EntityHistory.Selectors.Add("InventoryEntities", typeof(User), typeof(Tenant));
        }
