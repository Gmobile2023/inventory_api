...
namespace AuthServer.OpenIddict.Authorizations
{
    public class EfCoreOpenIddictAuthorizationRepository : AuthServerRepositoryBase<OpenIddictAuthorization, Guid>,
