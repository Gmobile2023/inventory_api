...
{
    public class UserRepository : AuthServerRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<AuthServerDbContext> dbContextProvider)
