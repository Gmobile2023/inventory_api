...
using AuthServer.EntityFrameworkCore.Repositories;

namespace AuthServer.Organizations
{
    public class UserOrganizationUnitRepository : AuthServerRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<AuthServerDbContext> dbContextProvider)
