...
{
    public class SubscriptionPaymentRepository : AuthServerRepositoryBase<SubscriptionPayment, long>,
        ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<AuthServerDbContext> dbContextProvider)
