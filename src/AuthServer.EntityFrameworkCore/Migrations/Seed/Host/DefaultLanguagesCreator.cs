...
namespace AuthServer.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AuthServerConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(AuthServerDbContext context)
        {
            _context = context;
        }
