...
namespace Inventory.Web.Authentication.JwtBearer
{
    public class InventoryAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public InventoryAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
