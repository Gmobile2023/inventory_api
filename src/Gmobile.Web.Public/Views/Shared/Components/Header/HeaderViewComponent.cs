...
using Gmobile.Url;
using Gmobile.Web.Public.Startup;
using Gmobile.Web.Session;
using Gmobile.Web.UiCustomization;

namespace Gmobile.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : GmobileViewComponent
    {
