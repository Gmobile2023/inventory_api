...
{
    [DependsOn(
        typeof(GmobileWebCoreModule)
    )]
    public class GmobileWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public GmobileWebFrontEndModule(IWebHostEnvironment env, GmobileEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GmobileWebFrontEndModule).GetAssembly());
        }
    }
}
