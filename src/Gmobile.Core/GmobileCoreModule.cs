...
using Gmobile.DashboardCustomization.Definitions;
using Gmobile.Debugging;
using Gmobile.DynamicEntityProperties;
using Gmobile.Features;
using Gmobile.Friendships;
using Gmobile.Friendships.Cache;
using Gmobile.Localization;
using Gmobile.MultiTenancy;
using Gmobile.Net.Emailing;
using Gmobile.Notifications;
using Gmobile.WebHooks;

namespace Gmobile
{
    [DependsOn(
        typeof(GmobileCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class GmobileCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            GmobileLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = GmobileConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, GmobileMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<GmobileSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GmobileCoreModule).GetAssembly());
        }
