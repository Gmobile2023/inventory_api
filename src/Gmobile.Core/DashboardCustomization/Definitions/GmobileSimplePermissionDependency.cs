...
/// </summary>
public class GmobileSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public GmobileSimplePermissionDependency()
    {
    ...
    public GmobileSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public GmobileSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
