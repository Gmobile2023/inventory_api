...
using Gmobile.Authentication;
using Gmobile.DashboardCustomization;
...
namespace Gmobile.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!GmobileConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        GmobileConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        GmobileDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        GmobileDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = GmobileDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{GmobileDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{GmobileDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = GmobileDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = GmobileDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    GmobileDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = GmobileDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{GmobileDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{GmobileDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = GmobileDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = GmobileDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    GmobileDashboardCustomizationConsts.Widgets.Tenant
        ...
        {
            return new LocalizableString(name, GmobileConsts.LocalizationSourceName);
        }
    }
}
