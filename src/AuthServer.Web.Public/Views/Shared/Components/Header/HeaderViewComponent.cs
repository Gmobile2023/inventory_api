...
using AuthServer.Web.Public.Startup;
using AuthServer.Web.Session;
using AuthServer.Web.UiCustomization;

namespace AuthServer.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : AuthServerViewComponent
    {
