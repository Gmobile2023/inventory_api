...
namespace AuthServer.Web.Public.Startup
{
    [DependsOn(
        typeof(AuthServerWebCoreModule)
    )]
    public class AuthServerWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public AuthServerWebFrontEndModule(IWebHostEnvironment env, AuthServerEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AuthServerWebFrontEndModule).GetAssembly());
        }
    }
}
