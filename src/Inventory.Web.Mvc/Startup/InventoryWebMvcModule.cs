...
namespace Inventory.Web.Startup
{
    ...
    public class InventoryWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public InventoryWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(InventoryWebMvcModule).GetAssembly());
        }
