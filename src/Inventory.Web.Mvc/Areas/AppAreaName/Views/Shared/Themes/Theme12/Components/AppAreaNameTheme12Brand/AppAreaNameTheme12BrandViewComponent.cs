...
namespace Inventory.Web.Areas.AppAreaName.Views.Shared.Themes.Theme12.Components.AppAreaNameTheme12Brand
{
    public class AppAreaNameTheme12BrandViewComponent : InventoryViewComponent
    {
