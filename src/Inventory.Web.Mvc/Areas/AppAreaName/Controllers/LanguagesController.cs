...
using Inventory.Web.Areas.AppAreaName.Models.Languages;
...
namespace Inventory.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : InventoryControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = InventoryConsts.LocalizationSourceName;
            }
