...
using Inventory.Configuration.Host;
using Inventory.Editions;
using Inventory.Timing;
using Inventory.Timing.Dto;
using Inventory.Web.Areas.AppAreaName.Models.HostSettings;
...
namespace Inventory.Web.Areas.AppAreaName.Controllers
{
    ...
    public class HostSettingsController : InventoryControllerBase
    {
