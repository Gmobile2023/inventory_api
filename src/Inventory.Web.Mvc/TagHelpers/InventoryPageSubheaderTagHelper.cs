...
using Inventory.UiCustomization.Dto;

namespace Inventory.Web.TagHelpers
{
    ...
    public class InventoryPageSubheaderTagHelper : TagHelper
    {
        ...
        public InventoryPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
