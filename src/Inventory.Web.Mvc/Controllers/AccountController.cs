...
using Inventory.Web.Security.Recaptcha;
using Inventory.Web.Session;
using Inventory.Web.Views.Shared.Components.TenantChange;
...
{
    public class AccountController : InventoryControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(InventoryConsts.DateTimeOffsetFormat));
