...
{
    public class InventoryMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public InventoryMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(InventoryConsts.LocalizationSourceName, name);
        }
    }
}