...
namespace Inventory
{
    ...
    public class InventoryCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.MultiTenancy.IsEnabled = InventoryConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, InventoryMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<InventorySmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
