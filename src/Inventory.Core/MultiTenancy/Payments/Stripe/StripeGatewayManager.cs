...
{
    public class StripeGatewayManager : InventoryServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Inventory";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + InventoryConsts.Currency;
        }
