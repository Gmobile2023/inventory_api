...
using Inventory.Authorization.Users.Password;
using Inventory.Configuration;
using Inventory.EntityFrameworkCore;
using Inventory.MultiTenancy;
using Inventory.Web.Startup.ExternalLoginInfoProviders;
...
namespace Inventory.Web.Startup
{
    ...
    public class InventoryWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public InventoryWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(InventoryWebHostModule).GetAssembly());
        }
