...
namespace Inventory.Migrations
{
    ...
    [Migration("20241105065534_Add Table Districts Cities Countries Wards")]
    partial class AddTableDistrictsCitiesCountriesWards
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory.Address.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Inventory.Address.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Inventory.Address.District", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Inventory.Address.Ward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Inventory.Address.City", b =>
                {
                    b.HasOne("Inventory.Address.Country", "CountryFk")
                        .WithMany()
            ...
            modelBuilder.Entity("Inventory.Address.District", b =>
                {
                    b.HasOne("Inventory.Address.City", "CityFk")
                        .WithMany()
            ...
            modelBuilder.Entity("Inventory.Address.Ward", b =>
                {
                    b.HasOne("Inventory.Address.District", "DistrictFk")
                        .WithMany()
