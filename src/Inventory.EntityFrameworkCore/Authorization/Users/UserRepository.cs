...
{
    public class UserRepository : InventoryRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<InventoryDbContext> dbContextProvider)
