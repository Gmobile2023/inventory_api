...
namespace Inventory.EntityFrameworkCore
{
    ...
    public class InventoryEntityFrameworkCoreModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            // Configuration.EntityHistory.Selectors.Add("InventoryEntities", EntityHistoryHelper.TrackedTypes);
            // Configuration.CustomConfigProviders.Add(new EntityHistoryConfigProvider(Configuration));
        }

        public override void Initialize()
        {
            IocManager.RegisterAssemblyByConvention(typeof(InventoryEntityFrameworkCoreModule).GetAssembly());
        }
