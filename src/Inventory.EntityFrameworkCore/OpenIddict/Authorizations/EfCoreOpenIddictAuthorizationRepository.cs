...
namespace Inventory.OpenIddict.Authorizations
{
    public class EfCoreOpenIddictAuthorizationRepository : InventoryRepositoryBase<OpenIddictAuthorization, Guid>,
