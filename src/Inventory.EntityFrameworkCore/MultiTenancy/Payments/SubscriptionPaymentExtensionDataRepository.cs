...
using Inventory.EntityFrameworkCore.Repositories;

namespace Inventory.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : InventoryRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<InventoryDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
