...
namespace AuthServer.Web.Startup
{
    ...
    public class AuthServerWebHostModule : AbpModule
    {
        ...
        public AuthServerWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AuthServerWebHostModule).GetAssembly());
        }
