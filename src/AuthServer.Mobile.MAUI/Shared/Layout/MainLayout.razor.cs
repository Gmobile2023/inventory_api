...
using AuthServer.Mobile.MAUI.Services.Account;
using AuthServer.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using AuthServer.Mobile.MAUI.Services.Tenants;
using AuthServer.Mobile.MAUI.Helpers;

#if ANDROID
using AuthServer.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace AuthServer.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new AuthServer.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
