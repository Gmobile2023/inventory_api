...
using Gmobile.Core.Base;
using Gmobile.Core.Extensions;
using Gmobile.Dto;
using Gmobile.Types;

namespace Gmobile.Queries
{
    public class OrganizationUnitQuery : GmobileQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
