...
using Gmobile.DemoUiComponents.Dto;

namespace Gmobile.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : GmobileAppServiceBase, IDemoUiComponentsAppService
    {
