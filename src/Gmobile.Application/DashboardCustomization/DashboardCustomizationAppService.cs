...
using Gmobile.DashboardCustomization.Dto;

namespace Gmobile.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : GmobileAppServiceBase, IDashboardCustomizationAppService
    {
