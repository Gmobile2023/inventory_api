...
using Gmobile.MultiTenancy.Payments.Stripe;
using Gmobile.MultiTenancy.Payments.Stripe.Dto;
using Stripe.Checkout;

namespace Gmobile.MultiTenancy.Payments
{
    public class StripePaymentAppService : GmobileAppServiceBase, IStripePaymentAppService
    {
                    ...
                    .Select(p => new SessionLineItemOptions
                    {
                        ...
                        PriceData = new SessionLineItemPriceDataOptions
                        {
                            ...
                            ProductData = new SessionLineItemPriceDataProductDataOptions
                            {
                                ...
                                Name = GmobileConsts.ProductName
                            }
                        }
                    }).ToList();
            }
