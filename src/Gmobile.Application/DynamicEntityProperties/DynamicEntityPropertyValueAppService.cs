...
using Gmobile.DynamicEntityPropertyValues.Dto;

namespace Gmobile.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : GmobileAppServiceBase, IDynamicEntityPropertyValueAppService
    {
