...
namespace Gmobile.Sessions
{
    public class SessionAppService : GmobileAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = GmobileConsts.Currency,
                        CurrencySign = GmobileConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = GmobileConsts.AllowTenantsToChangeEmailSettings,
