...
using Gmobile.Auditing.Exporting;
using Gmobile.Authorization;
using Gmobile.Authorization.Users;
using Gmobile.Dto;
using Gmobile.EntityHistory;
using EntityHistoryHelper = Gmobile.EntityHistory.EntityHistoryHelper;

namespace Gmobile.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : GmobileAppServiceBase, IAuditLogAppService
    {
