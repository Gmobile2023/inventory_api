...
using AuthServer.MultiTenancy.Payments.Paypal;
using AuthServer.MultiTenancy.Payments.PayPal;
using AuthServer.MultiTenancy.Payments.PayPal.Dto;

namespace AuthServer.MultiTenancy.Payments
{
    public class PayPalPaymentAppService : AuthServerAppServiceBase, IPayPalPaymentAppService
    {
