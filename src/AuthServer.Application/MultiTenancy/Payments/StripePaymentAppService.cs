...
using AuthServer.MultiTenancy.Payments.Stripe;
using AuthServer.MultiTenancy.Payments.Stripe.Dto;
using Stripe.Checkout;

namespace AuthServer.MultiTenancy.Payments
{
    public class StripePaymentAppService : AuthServerAppServiceBase, IStripePaymentAppService
    {
                    ...
                    .Select(p => new SessionLineItemOptions
                    {
                        ...
                        PriceData = new SessionLineItemPriceDataOptions
                        {
                            ...
                            ProductData = new SessionLineItemPriceDataProductDataOptions
                            {
                                ...
                                Name = AuthServerConsts.ProductName
                            }
                        }
                    }).ToList();
            }
