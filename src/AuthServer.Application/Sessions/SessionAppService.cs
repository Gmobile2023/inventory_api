...
using AuthServer.Features;

namespace AuthServer.Sessions
{
    public class SessionAppService : AuthServerAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = AuthServerConsts.Currency,
                        CurrencySign = AuthServerConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = AuthServerConsts.AllowTenantsToChangeEmailSettings,
