...
using AuthServer.Configuration.Tenants.Dto;
using AuthServer.Security;
using AuthServer.Storage;
using AuthServer.Timing;

namespace AuthServer.Configuration.Tenants
{
    ...
    public class TenantSettingsAppService : SettingsAppServiceBase, ITenantSettingsAppService
    {
        ...
        {
            if (_multiTenancyConfig.IsEnabled && !AuthServerConsts.AllowTenantsToChangeEmailSettings)
            {
                return;
            }
