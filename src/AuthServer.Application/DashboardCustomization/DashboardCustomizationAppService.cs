...
using AuthServer.DashboardCustomization.Definitions;
using AuthServer.DashboardCustomization.Dto;

namespace AuthServer.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : AuthServerAppServiceBase, IDashboardCustomizationAppService
    {
