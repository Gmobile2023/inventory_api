...
using AuthServer.Migrations.Seed;
using AuthServer.Migrations.Seed.Host;
...
namespace AuthServer.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : AuthServerAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<AuthServerDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{AuthServerConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{AuthServerConsts.ConnectionStringName}", constring);
        }
