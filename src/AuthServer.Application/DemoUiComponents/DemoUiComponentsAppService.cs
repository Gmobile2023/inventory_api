...
using AuthServer.DemoUiComponents.Dto;

namespace AuthServer.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : AuthServerAppServiceBase, IDemoUiComponentsAppService
    {
