...
using AuthServer.Authorization.Users.Profile.Cache;
using AuthServer.Authorization.Users.Profile.Dto;
using AuthServer.Configuration;
using AuthServer.Friendships;
using AuthServer.Gdpr;
using AuthServer.Net.Sms;
using AuthServer.Security;
using AuthServer.Storage;
using AuthServer.Timing;
using AuthServer.Url;

namespace AuthServer.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : AuthServerAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("AuthServer",
