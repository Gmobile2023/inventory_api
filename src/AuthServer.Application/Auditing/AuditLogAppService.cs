...
using AuthServer.Auditing.Exporting;
using AuthServer.Authorization;
using AuthServer.Authorization.Users;
using AuthServer.Dto;
using AuthServer.EntityHistory;
using EntityHistoryHelper = AuthServer.EntityHistory.EntityHistoryHelper;

namespace AuthServer.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : AuthServerAppServiceBase, IAuditLogAppService
    {
