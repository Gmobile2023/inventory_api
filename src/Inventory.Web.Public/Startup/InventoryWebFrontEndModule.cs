...
namespace Inventory.Web.Public.Startup
{
    [DependsOn(
        typeof(InventoryWebCoreModule)
    )]
    public class InventoryWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public InventoryWebFrontEndModule(IWebHostEnvironment env, InventoryEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(InventoryWebFrontEndModule).GetAssembly());
        }
    }
}
