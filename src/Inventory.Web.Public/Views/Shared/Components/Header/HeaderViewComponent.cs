...
using Inventory.Url;
using Inventory.Web.Public.Startup;
using Inventory.Web.Session;
using Inventory.Web.UiCustomization;

namespace Inventory.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : InventoryViewComponent
    {
