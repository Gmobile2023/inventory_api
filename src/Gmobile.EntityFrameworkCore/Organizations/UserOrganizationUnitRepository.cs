...
using Gmobile.EntityFrameworkCore.Repositories;

namespace Gmobile.Organizations
{
    public class UserOrganizationUnitRepository : GmobileRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<GmobileDbContext> dbContextProvider)
