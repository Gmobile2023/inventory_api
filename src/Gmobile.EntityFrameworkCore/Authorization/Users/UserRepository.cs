...
{
    public class UserRepository : GmobileRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<GmobileDbContext> dbContextProvider)
