...
{
    public class SubscriptionPaymentRepository : GmobileRepositoryBase<SubscriptionPayment, long>,
        ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<GmobileDbContext> dbContextProvider)
