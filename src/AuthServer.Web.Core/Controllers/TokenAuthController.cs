...
using AuthServer.Authentication.TwoFactor.Google;
using AuthServer.Authorization;
using AuthServer.Authorization.Accounts.Dto;
...
using AuthServer.Web.Models.TokenAuth;
using AuthServer.Authorization.Impersonation;
using AuthServer.Authorization.Roles;
using AuthServer.Configuration;
using AuthServer.Identity;
using AuthServer.Net.Sms;
using AuthServer.Notifications;
using AuthServer.Security.Recaptcha;
using AuthServer.Web.Authentication.External;
...
namespace AuthServer.Web.Controllers
{
    ...
    public class TokenAuthController : AuthServerControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, Tenant tenant, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(AuthServerConsts.DateTimeOffsetFormat));
