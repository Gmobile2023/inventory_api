...
using AuthServer.Authentication.TwoFactor;
using AuthServer.Chat;
using AuthServer.Configuration;
using AuthServer.EntityFrameworkCore;
using AuthServer.Startup;
using AuthServer.Web.Authentication.JwtBearer;
using AuthServer.Web.Authentication.TwoFactor;
using AuthServer.Web.Chat.SignalR;
using AuthServer.Web.Common;
using AuthServer.Web.Configuration;
using AuthServer.Web.DashboardCustomization;
using Abp.Extensions;
using Abp.HtmlSanitizer;
using Abp.HtmlSanitizer.Configuration;
using AuthServer.Authorization.Accounts;
...
namespace AuthServer.Web
{
    ...
    public class AuthServerWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AuthServerWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.DefaultNameOrConnectionString = _appConfiguration.GetConnectionString(
                AuthServerConsts.ConnectionStringName
            );
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(AuthServerApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AuthServerWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(AuthServerWebCoreModule).Assembly);
        }
