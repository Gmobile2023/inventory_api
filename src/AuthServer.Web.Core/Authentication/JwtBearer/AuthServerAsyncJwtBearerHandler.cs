...
namespace AuthServer.Web.Authentication.JwtBearer
{
    public class AuthServerAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public AuthServerAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
