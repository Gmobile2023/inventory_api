...
using Gmobile.Authorization.Users.Password;
...
using Gmobile.Web.Startup.ExternalLoginInfoProviders;
...
namespace Gmobile.Web.Startup
{
    ...
    public class GmobileWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public GmobileWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GmobileWebHostModule).GetAssembly());
        }
