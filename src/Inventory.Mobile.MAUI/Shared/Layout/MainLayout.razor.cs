...
using Inventory.Mobile.MAUI.Services.Account;
using Inventory.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using Inventory.Mobile.MAUI.Services.Tenants;

#if ANDROID
using Inventory.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace Inventory.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new Inventory.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
