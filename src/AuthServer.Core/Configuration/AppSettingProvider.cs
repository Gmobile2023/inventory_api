...
using AuthServer.DashboardCustomization;
...
namespace AuthServer.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!AuthServerConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        AuthServerConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        AuthServerDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        AuthServerDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = AuthServerDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{AuthServerDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{AuthServerDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = AuthServerDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = AuthServerDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    AuthServerDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = AuthServerDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{AuthServerDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{AuthServerDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = AuthServerDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = AuthServerDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    AuthServerDashboardCustomizationConsts.Widgets.Tenant
        ...
        {
            return new LocalizableString(name, AuthServerConsts.LocalizationSourceName);
        }
    }
}
