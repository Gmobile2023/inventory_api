...
{
    public class StripeGatewayManager : AuthServerServiceBase,
        ...
        ITransientDependency
    {
        ...
        public async Task<StripeIdResponse> GetOrCreatePlanForPayment(long paymentId)
        {
            ...
            var product = await GetOrCreateProductAsync(AuthServerConsts.ProductName);
