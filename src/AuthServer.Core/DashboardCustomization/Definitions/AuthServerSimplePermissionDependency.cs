...
/// </summary>
public class AuthServerSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public AuthServerSimplePermissionDependency()
    {
    ...
    public AuthServerSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public AuthServerSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
