...
namespace Inventory.Core.Base
{
    public abstract class InventoryQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected InventoryQueryBase(string fieldName,
