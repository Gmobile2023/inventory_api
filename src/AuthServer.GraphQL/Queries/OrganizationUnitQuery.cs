...
using AuthServer.Core.Base;
using AuthServer.Core.Extensions;
using AuthServer.Dto;
using AuthServer.Types;

namespace AuthServer.Queries
{
    public class OrganizationUnitQuery : AuthServerQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
