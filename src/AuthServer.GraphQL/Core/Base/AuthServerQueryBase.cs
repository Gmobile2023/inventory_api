...
namespace AuthServer.Core.Base
{
    public abstract class AuthServerQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected AuthServerQueryBase(string fieldName,
