...
using Gmobile.Authentication.TwoFactor;
using Gmobile.Chat;
using Gmobile.Configuration;
using Gmobile.EntityFrameworkCore;
using Gmobile.Startup;
using Gmobile.Web.Authentication.JwtBearer;
using Gmobile.Web.Authentication.TwoFactor;
using Gmobile.Web.Chat.SignalR;
using Gmobile.Web.Common;
using Gmobile.Web.Configuration;
using Gmobile.Web.DashboardCustomization;
using Abp.Extensions;
using Abp.HtmlSanitizer;
using Abp.HtmlSanitizer.Configuration;
using Gmobile.Authorization.Accounts;

namespace Gmobile.Web
{
    [DependsOn(
        typeof(GmobileApplicationModule),
        typeof(GmobileEntityFrameworkCoreModule),
    ...
    public class GmobileWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public GmobileWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(GmobileApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GmobileWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(GmobileWebCoreModule).Assembly);
        }
