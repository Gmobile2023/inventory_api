...
namespace Gmobile.Web.Authentication.JwtBearer
{
    public class GmobileAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public GmobileAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
