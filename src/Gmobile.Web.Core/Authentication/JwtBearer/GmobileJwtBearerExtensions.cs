...
/// </summary>
public static class GmobileJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, GmobileAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
