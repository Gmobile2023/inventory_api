...
using Gmobile.Authentication.TwoFactor.Google;
...
namespace Gmobile.Web.Controllers
{
    ...
    public class TokenAuthController : GmobileControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, Tenant tenant, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(GmobileConsts.DateTimeOffsetFormat));
