...
{
    public class SessionAppService : InventoryAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = InventoryConsts.Currency,
                        CurrencySign = InventoryConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = InventoryConsts.AllowTenantsToChangeEmailSettings,
