...
using Inventory.DynamicEntityPropertyValues.Dto;

namespace Inventory.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : InventoryAppServiceBase, IDynamicEntityPropertyValueAppService
    {
