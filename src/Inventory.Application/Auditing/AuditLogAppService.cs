...
using Inventory.Auditing.Exporting;
using Inventory.Authorization;
using Inventory.Authorization.Users;
using Inventory.Dto;
using Inventory.EntityHistory;
using EntityHistoryHelper = Inventory.EntityHistory.EntityHistoryHelper;

namespace Inventory.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : InventoryAppServiceBase, IAuditLogAppService
    {
