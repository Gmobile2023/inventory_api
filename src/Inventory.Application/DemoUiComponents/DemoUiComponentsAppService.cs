...
using Inventory.DemoUiComponents.Dto;

namespace Inventory.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : InventoryAppServiceBase, IDemoUiComponentsAppService
    {
