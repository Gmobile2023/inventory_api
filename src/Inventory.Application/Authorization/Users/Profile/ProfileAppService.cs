...
using Inventory.Authorization.Users.Profile.Cache;
using Inventory.Authorization.Users.Profile.Dto;
using Inventory.Configuration;
using Inventory.Friendships;
using Inventory.Gdpr;
using Inventory.Net.Sms;
using Inventory.Security;
using Inventory.Storage;
using Inventory.Timing;

namespace Inventory.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : InventoryAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Inventory",
