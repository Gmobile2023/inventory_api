...
using Gmobile.Services.Navigation;
using Microsoft.AspNetCore.Components;
using Gmobile.Mobile.MAUI.Services.Account;
using Gmobile.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using Gmobile.Mobile.MAUI.Services.Tenants;
using Gmobile.Mobile.MAUI.Helpers;

#if ANDROID
using Gmobile.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace Gmobile.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new Gmobile.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
